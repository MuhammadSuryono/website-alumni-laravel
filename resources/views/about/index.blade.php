@extends('layout')
@section('slider')
    @include('components.slider-page')
@endsection
...
@section("content")
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="about-image mt-50">
                        <img src="{{ url("template/images/about/about-2.jpg") }}" alt="About">
                    </div>  <!-- about imag -->
                </div>
            </div> <!-- row -->
    ...
    <div id="counter-part" class="bg_cover pt-65 pb-110" data-overlay="8"
         style="background-image: url({{ url("template/images/bg-2.jpg)") }})">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="{{ url("template/images/teachers/t-1.jpg") }}" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a href="{{ url("template/teachers-singel.html") }}"><h6>Mark alen</h6></a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="{{ url("template/images/teachers/t-2.jpg") }}" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a href="{{ url("template/teachers-singel.html") }}"><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="{{ url("template/images/teachers/t-3.jpg") }}" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a href="{{ url("template/teachers-singel.html") }}"><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="{{ url("template/images/teachers/t-4.jpg") }}" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a href="{{ url("template/teachers-singel.html") }}"><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="{{ url("template/images/teachers/t-5.jpg") }}" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a href="{{ url("template/teachers-singel.html") }}"><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="{{ url("template/images/teachers/t-6.jpg") }}" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a href="{{ url("template/teachers-singel.html") }}"><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="{{ url("template/images/teachers/t-7.jpg") }}" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a href="{{ url("template/teachers-singel.html") }}"><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="{{ url("template/images/teachers/t-8.jpg") }}" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a href="{{ url("template/teachers-singel.html") }}"><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
        ...
        <div class="container">
            ...
            <div class="row testimonial-slied mt-40">
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ url("template/images/testimonial/t-1.jpg") }}" alt="Testimonial">
                            <div class="quote">
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ url("template/images/testimonial/t-2.jpg") }}" alt="Testimonial">
                            <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ url("template/images/testimonial/t-3.jpg")  }}" alt="Testimonial">
                            <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div>
                        </div>
